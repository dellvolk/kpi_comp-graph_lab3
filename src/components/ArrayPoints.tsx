                        ...
                        {fields.map(({key, name, ...restField}) => (
                            <Space key={key} style={{marginBottom: 8, flexWrap: 'wrap'}} align="baseline">
                                ...
                                <Form.Item
                                    ...
                                    initialValue={1}
                                >
                                    <InputNumber placeholder="C_x" defaultValue={1}/>
                                </Form.Item>
                                <Form.Item
                                    {...restField}
                                    name={[name, 'wc']}
                                ...
                                <Form.Item
                                    ...
                                    initialValue={.4}
                                >
                                    <InputNumber placeholder="f" min={.01} max={.49} step={0.1}/>
                                </Form.Item>
                                <Form.Item
                                    {...restField}
                                    name={[name, 'u']}
